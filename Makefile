...
# main build and restart for production
rebuild-prod: clean-docker build-prod restart-prod restart-nginx


# Development build and deployment with docker-compose-dev.yml
build-dev:
	docker compose -f docker-compose-dev.yml build superset

restart-dev:
	docker compose -f docker-compose-dev.yml down
	docker compose -f docker-compose-dev.yml up -d

# main build and restart for development
rebuild-dev: clean-docker build-dev restart-dev restart-nginx
