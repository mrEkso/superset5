...
const TR_STYLE = 'style="opacity:0.8;line-height:1.6;"';
const TR_FOCUS_STYLE = 'style="font-weight:700;line-height:1.6;"';
const TD_TEXT_STYLE =
  'style="text-align:left;padding-left:0px;max-width:300px;overflow:hidden;text-overflow:ellipsis;"';
const TD_NUMBER_STYLE =
  'style="text-align:right;padding-left:24px;max-width:300px;overflow:hidden;text-overflow:ellipsis;"';
