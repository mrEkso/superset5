...
const ControlPopover: FC<PopoverProps> = ({
  ...
  const [placement, setPlacement] = React.useState<TooltipPlacement>(props.placement || 'right');

  const calculatePlacement = useCallback(() => {
    if (props.placement && !props.placement.startsWith('right')) {
      return;
    }
  ...
  }, [getVisibilityRatio, props.placement]);
